...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(self.currentTaskType == kServiceTag_UndoTaskList_Action)
    {
        ...
        NSString *BZCLR = [NSString stringWithFormat:@"当前处理人：%@ 流程名称：%@", [dict objectForKey:@"BZCLR"], [dict objectForKey:@"LCMC"]];
        NSString *LCKSSJ = [NSString stringWithFormat:@"流程开始时间：%@ 办结期限：%@", [dict objectForKey:@"LCKSSJ"], [dict objectForKey:@"LCQX"]];
        NSString *LCLXBH = [dict objectForKey:@"LCLXBH"];
        cell = [UITableViewCell makeSubCell:tableView andWithTitle1:title andWithTitle2:BZCLR andWithTitle3:LCKSSJ andWithTaskType:LCLXBH];
    }
    else if (self.currentTaskType == kServiceTag_DoneTaskList_Action)
    {
        ...
        NSDictionary *dict = [self.listDataArray objectAtIndex:indexPath.row];
        NSString *title = [dict objectForKey:@"DWMC"];
        NSString *BZCLR = [NSString stringWithFormat:@"处理人：%@ 流程名称：%@", [dict objectForKey:@"BZCLR"], [dict objectForKey:@"LCMC"]];
        NSString *LCKSSJ = [NSString stringWithFormat:@"流程开始时间：%@ 流程结束时间：%@", [dict objectForKey:@"LCKSSJ"], [dict objectForKey:@"BJRQ"]];
        NSString *LCLXBH = [dict objectForKey:@"LCLXBH"];
        cell = [UITableViewCell makeSubCell:tableView andWithTitle1:title andWithTitle2:BZCLR andWithTitle3:LCKSSJ andWithTaskType:LCLXBH];
    }
