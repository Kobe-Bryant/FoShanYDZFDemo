...
-(void)finishAction:(id)sender{
    ...
    controller.canSignature = [[dicActionInfo objectForKey:@"canSignature"] boolValue];
...
-(void)handleActionInfo:(NSDictionary *)actionInfo{
    ...
    NSNumber *isFirstStep = [dicActionInfo objectForKey:@"isFirstStep"];
    NSNumber *canFinish = [dicActionInfo objectForKey:@"canFinish"];
    ...
    NSNumber *canTransition = [dicActionInfo objectForKey:@"canTransition"];
    ...
    NSNumber *canSendback = [dicActionInfo objectForKey:@"canSendback"];
    ...
    NSNumber *isCanFeedback = [dicActionInfo objectForKey:@"isCanFeedback"];
    ...
    NSNumber *isCanEndorse = [dicActionInfo objectForKey:@"isCanEndorse"];
