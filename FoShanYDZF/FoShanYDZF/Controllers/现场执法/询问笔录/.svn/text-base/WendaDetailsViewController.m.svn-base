...
- (void)viewDidLoad
{
    ...
    NSArray *wordsArray =  [[NSArray alloc] initWithObjects:@"你在公司担任何种职务？和本案有何关系？",
     @"你公司名称是什么？什么时候开始建设？什么时候投入生产？",
     @"你公司法定代表人是谁？是否有取得工商营业执照？是否申领污染物排放许可证？",
     @"你公司是否经过建设项目环境评价文件审批？是否有建设项目竣工环境保护验收",
     @"你公司主要从事何种生产经营？主要生产设备有哪些？",
     @"你公司生产中主要产生的污染物有哪些？配套了何种污染治理设施",
     @"以上违法行为是否属实？",
     @"以上内容是否属实？", nil];
    /*[[NSArray alloc] initWithObjects:@"你在单位担任什么职务？",
