...
-(void)downloadFile
{
    ...
    NSLog(@"%@ %@", self.xczfzh ,[self.xczfzh lastPathComponent]);
    [params setObject:[self.xczfzh lastPathComponent] forKey:@"PATH"];
...
-(void) handleDoubleTap:(UITapGestureRecognizer *)recognizer
{
    if (imageBackView == nil)
    {
        ...
        btn.frame = CGRectMake(730-34,-4, closeimg.size.width,closeimg.size.height);
