        ...
        statusImage:(UIImage*)statusImg
{
    if (self = [super init]) {
        ...
        self.imgView = [[UIImageView alloc] initWithImage:statusImg];
        self.imgView.frame = CGRectMake(10, 45, 40, 40);
         [self addSubview:self.imgView];
        
        CGFloat contentLabelWidth = kAlertWidth - 60;
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake(55, CGRectGetMaxY(self.alertTitleLabel.frame), contentLabelWidth, 60)];
