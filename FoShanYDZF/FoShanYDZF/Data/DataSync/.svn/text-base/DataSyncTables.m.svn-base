...
+(NSArray*)tableNamesAry{
    ...
    {
       // NSArray *ary = [[NSArray alloc] initWithObjects:@"T_ADMIN_RMS_ZZJG",@"T_ADMIN_RMS_YH",@"T_YDZF_HBJMC_JCDDCW",nil];
        NSArray *ary = [[NSArray alloc] initWithObjects:@"T_ADMIN_RMS_ZZJG",@"T_ADMIN_RMS_YH",nil];
        return ary;
    }else{
      //  NSArray *ary = [[NSArray alloc] initWithObjects:@"T_ADMIN_RMS_ZZJG",@"T_ADMIN_RMS_YH",@"T_YDZF_HBJMC_JCDDCW",@"T_YDZF_FLFG",nil];
